...
//       if (!res.ok) {
//         const errorData = await res.json();
//         toast.error(errorData.error || 'Erro ao editar cliente');
//         return;
//       }
...
//       fetchClientes();
//     } catch (error) {
//       toast.error('Erro inesperado ao editar cliente');
//     }
//   };
...
//       <p className="text-lg font-medium font-poppins text-gray-600 animate-pulse">Carregando clientes...</p>
//     </div>
//   );
...
//                 <th className="py-3 px-4 text-left text-sm font-semibold font-poppins text-gray-700">Vendas</th>
